...
{
    [OSInterface(Name = "PrivateLLM", Description= "Experimental free and fully local AI for ODC.", IconResourceName = "PrivateLM.resources.privatelm_logo.png")]
    public interface IPrivateLM
    {
